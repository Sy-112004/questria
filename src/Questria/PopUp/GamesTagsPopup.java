...
public class GamesTagsPopup extends JDialog {
    ...
    public GamesTagsPopup(JFrame parent) {
        ...
        // Topic line
        JLabel topic = new JLabel("Topic: Games");
        ...
        addTagRow("pc-games",     new Color(0xF06B6B)); // red
        addTagRow("Mobile games", new Color(0x5FA3E6)); // blue
        addTagRow("rpg",          new Color(0xC2D4F2)); // light blue
        addTagRow("Strategy",     new Color(0xF7B4D4)); // pink
        ...
        addButton.addActionListener(e -> {
            System.out.println("Selected games tags: " + selectedTags);
            dispose();
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            new GamesTagsPopup(host).setVisible(true);
        });
    }
}
