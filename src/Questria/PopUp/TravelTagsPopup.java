...
public class TravelTagsPopup extends JDialog {
    ...
    public TravelTagsPopup(JFrame parent) {
        super(parent, true);                 // modal
        setUndecorated(true);                // not draggable
        setSize(DIALOG_W, DIALOG_H);
        setLocationRelativeTo(parent);
        setBackground(new Color(0, 0, 0, 0)); // for rounded painting

        // Rounded background with soft border/shadow
        ...
        // Topic line
        JLabel topic = new JLabel("Topic: Travel");
        ...
        addTagRow("Budget Travel", new Color(0xF28C8C)); // red
        addTagRow("Itineraries",   new Color(0x8AB8F5)); // blue
        addTagRow("local tips",    new Color(0xC2D4F2)); // light blue
        addTagRow("Solo travel",   new Color(0xF7B4D4)); // pink
        ...
        addButton.addActionListener(e -> {
            System.out.println("Selected travel tags: " + selectedTags);
            dispose();
        });
    ...
    private static class TagChip extends JComponent {
        ...
        @Override public Dimension getPreferredSize() {
            ...
            int w = fm.stringWidth(text) + 24; // L/R padding
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            new TravelTagsPopup(host).setVisible(true);
        });
    }
}
