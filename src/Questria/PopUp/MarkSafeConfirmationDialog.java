...
public class MarkSafeConfirmationDialog {
    ...
    public static void show(Component parent, Runnable onConfirmMarkSafe) {
        ...
        JLabel titleLabel = new JLabel("Mark as Safe?");
        ...
        JLabel messageLabel = new JLabel("This will mark the post as safe and approved.");
        ...
        confirmBtn.addActionListener(e -> {
            dialog.dispose();
            if (onConfirmMarkSafe != null) onConfirmMarkSafe.run();
        });
